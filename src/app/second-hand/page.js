    ...
    <div className="container" style={{ maxWidth: "1200px", margin: "0 auto", padding: "40px 20px", minHeight: "100vh" }}>
      ...
      <div className="glass-panel" style={{ padding: "20px", borderRadius: "16px", marginBottom: "32px", display: "flex", flexWrap: "wrap", gap: "16px", border: "1px solid var(--border-glass)" }}>
        ...
        <div style={{ flex: "1 1 200px" }}>
          <label style={{ fontSize: "var(--font-caption)", color: "var(--text-muted)", display: "block", marginBottom: "6px", fontWeight: "var(--font-weight-semibold)" }}>Search Keyword</label>
          <input
            type="text"
        ...
        <div style={{ flex: "1 1 150px", display: "flex", gap: "8px" }}>
          <div style={{ width: "50%" }}>
            <label style={{ fontSize: "var(--font-caption)", color: "var(--text-muted)", display: "block", marginBottom: "6px", fontWeight: "var(--font-weight-semibold)" }}>Min Price</label>
            <input
              type="number"
              className="form-input"
              placeholder="Min"
          ...
          <div style={{ width: "50%" }}>
            <label style={{ fontSize: "var(--font-caption)", color: "var(--text-muted)", display: "block", marginBottom: "6px", fontWeight: "var(--font-weight-semibold)" }}>Max Price</label>
            <input
              type="number"
              className="form-input"
              placeholder="Max"
        ...
        {/* Sorting option */}
        <div style={{ flex: "1 1 180px" }}>
          <label style={{ fontSize: "var(--font-caption)", color: "var(--text-muted)", display: "block", marginBottom: "6px", fontWeight: "var(--font-weight-semibold)" }}>Sort By</label>
          <select
            className="form-input"
            value={sortBy}
